...
export function createStaticBodies(
  ...
  const leftWallPos = new RAPIER.Vector3(-(boardWidth / 2 + wallMargin), 0, 0);
  ...
  const rightWallPos = new RAPIER.Vector3(boardWidth / 2 + wallMargin, 0, 0);
  ...
  leftWallMesh.position = new Vector3(
    leftWallPos.x,
    leftWallPos.y,
    leftWallPos.z
  );
  ...
  rightWallMesh.position = new Vector3(
    rightWallPos.x,
    rightWallPos.y,
    rightWallPos.z
  );
